...
{% figure(alt=["OCULAR offline calibration pipeline"] src=["./offline_diagram_v2.svg?v=20260610-new-diagram1"] dark_src=["./offline_diagram_v2_dark.svg?v=20260610-new-diagram1"]) %}
