...
{% figure(alt=["OCULAR offline calibration pipeline"] src=["./offline_diagram_v2.png"] dark_src=["./offline_diagram_v2_dark.png?v=20260608-black"]) %}
...
{% figure(alt=["OCULAR online uncertainty calibration pipeline"] src=["./online_diagram_v2.png"] dark_src=["./online_diagram_v2_dark.png?v=20260608-black"]) %}
